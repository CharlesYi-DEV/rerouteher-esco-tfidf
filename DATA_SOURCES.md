...
| Project ESCO-to-MASCO label crosswalk | Retains ESCO codes/titles beside six-digit MASCO predictions for comparison | Project-curated mapping; not an official ESCO-to-MASCO publication and pending domain-owner review. |
...
official published crosswalk. ESCO codes and titles remain in API/UI output for
comparison and require domain-owner confirmation before any production
decision. Four-digit MASCO group codes appear only for source lineage; all
deployed role labels and predictions match `^\d{6}$`.
